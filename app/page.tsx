...
export default function HomePage() {
    ...
    // Hide weak case studies
    const hiddenSlugs = [
        "career-pathways-app-concept",
        "er-triage-support-app",
        "home-security-system-redesign",
    ];
    const work = allWork.filter((w) => !hiddenSlugs.includes(w.slug));
    const years =
        work.length > 0
            ...
            <section className="hero">
                <div className="container hero-grid">
                    <div className="hero-text">
                        ...
                        <h1 className="reveal">
                            {renderHeadline(siteConfig.headline)}
                        </h1>
                        ...
                        <div className="hero-meta reveal">
                            <div>
                                Based in <span>{siteConfig.location}</span>
                            </div>
                            <div>
                                Available <span>{siteConfig.status}</span>
                            </div>
                            <div>
                                Latest <span>{siteConfig.currently}</span>
                            </div>
                        </div>
                    </div>
                    <img
                ...
                <div className="container">
                    ...
                    <div className="work-list">
                        {work.length === 0 && (
                            ...
                            >
                                No case studies yet. Add <code>.mdx</code> files
                                to <code>content/work/</code> to get started.
                            </p>
                        )}
                        {work.map((w, i) => (
                            <Link
                    ...
                    work gives a scanning reader nothing to catch. */}
                                ...
                                <span className="work-body">
                                    ...
                                    <span className="work-summary">
                                        {w.frontmatter.summary}
                                    </span>
                                    {w.frontmatter.outcomes &&
                                        w.frontmatter.outcomes.length > 0 && (
